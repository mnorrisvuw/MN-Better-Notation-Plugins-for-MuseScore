...
* **MN Check Layout & Instrumentation** checks for over 170 different layout, notation and instrumentation problems, such as:
  ...
  * **Dynamics**: missing first dynamic, redundant dynamics, long hairpins not ‘terminated’, incorrect location for dynamics, dynamic needing restating after long rest, ‘dim.’/‘cresc.’ used instead of hairpins, long passages without dynamics, dynamics or hairpins placed under a rest, hairpins dragged away from their correct location, sforzando markings without accents, compound dynamics (e.g. sfzp) that are unrealisable, dynamics attached to the wrong object, overlapping hairpins
